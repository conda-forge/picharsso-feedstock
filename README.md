...
Once the `conda-forge` channel has been enabled, `picharsso` can be installed with:

```
conda install picharsso
```

It is possible to list all of the versions of `picharsso` available on your platform with:
